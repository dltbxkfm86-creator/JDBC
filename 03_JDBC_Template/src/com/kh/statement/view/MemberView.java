...
/**
 * MemeberView 클래스는 JDBC 실습을 위해 생성하였으며, 사용자에게 입력 및 출력을 수행하는 메소드를 제공합니다.
 * 
 * @author 홍길동
 * @version 0.1
 * @date 2025-09-01
...
public class MemberView {
	...
	public void mantMenu() {
		/*
		 * 2025 / 09 / 01 오늘의 실습 겸 숙제  
		 * 
		 * 금요일 숙제 3번 --> 나만의 테이블만들기
		 * 
		 * 나만의 테이블에 INSERT
		 * 전체조회
		 ...
		 * 
		 * 어제했던 결과물을 -> PrepardfStatement 버전으로 변경
		 * 
		 * 나만의 테이블에 INSERT
		 * 전체조회
		 * 유니크제약조건 걸려있는 컬럼으로 조회
	...
	private void findById() {
		...
		/*
		 * 자바에서 값의 종류 정수 = byte, short, int, long 실수 = float, double 문자 = char 논리값 =
		 * boolean
		 * 
		 * 주소값 = 나머지 다
		 */
